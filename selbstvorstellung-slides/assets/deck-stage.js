 ...
 *
 * Handles:
 *  (a) posts {slideIndexChanged: N} to the parent window on nav (optional host UI).
...
(() => {
  ...
  class DeckStage extends HTMLElement {
    ...
    _applyIndex({ showOverlay = true, broadcast = true, reason = 'init' } = {}) {
      ...
      if (broadcast) {
        // (1) Host-window postMessage for optional companion UI.
    ...
    _onHashChange() {
      ...
      this._restoreIndex();
      if (this._index !== prev) {
        this._applyIndex({ showOverlay: false, broadcast: true, reason: 'hash' });
      }
    }
